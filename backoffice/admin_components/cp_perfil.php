...
<section class="container mt-5 ps-5">
    <div class="row">
        <div class="card col-md-4 fundoCinzento">
        ...
        <div>
            ...
            if (isset($_GET['eventodata'])) {
                ...
                $query = "SELECT eventos_marcados.data, eventos.local, eventos.nome, eventos.descricao, eventos.imagem 
                ...
                if (mysqli_stmt_prepare($stmt, $query)) {
                    ...
                    mysqli_stmt_bind_result($stmt,  $data, $local, $nome, $descricao, $imagem);
