<div class="mt-5 container">
    ...
    <h3 class="ps-2">Escolhe uma turma para apagar</h3>
...
mysqli_stmt_prepare($stmt, "SELECT ano, letra, id_turma from turmas");
mysqli_stmt_execute($stmt);
mysqli_stmt_bind_result($stmt, $ano, $letra, $id);
        ...
        <div class="col-md-4 mb-md-0 mt-5">
            <div class="card pb-2 h-100 shadow rounded">
                <div class="card-body text-center">
                    ...
                    <a href="admin_scripts/sc_apagar_turma.php?id=' . $id . '" class="mt-2 btn btn-outline-secondary tipo-filme mb-0 small text-black-50">
