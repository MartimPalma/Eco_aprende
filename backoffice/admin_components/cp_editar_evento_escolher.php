...
include_once "cp_navbar.php";?>
    ...
    <h3 class="ps-2">Escolhe um evento para editar</h3>
...
mysqli_stmt_prepare($stmt, "SELECT id_evento, nome, local FROM eventos");
mysqli_stmt_execute($stmt);
mysqli_stmt_bind_result($stmt, $id, $nome, $local);
        ...
        <div class="col-md-4 mb-md-0 mt-5">
            <div class="card pb-2 h-100 shadow rounded">
                <div class="card-body text-center">
                    ...
                    <a href="editar_evento.php?id=' . $id . '" class="mt-2 btn btn-outline-secondary tipo-filme mb-0 small text-black-50">
