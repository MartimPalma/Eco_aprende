...
?>
    ...
    <div class="mt-5 container">
        ...
        <h3 class="ps-2">Insere as informações do novo aluno</h3>
        <div class="d-flex justify-content-center">
            <form class="col-12" action="admin_scripts/sc_inserir_docente.php" method="post" class="was-validated">
                <div class="mb-3 mt-3">
                ...
                <div class="mb-3 mt-4">
                    ...
                    <input type="email" class="form-control" id="email" value="" name="email" rows="5" required></input>
                    <div class="valid-feedback">Valid.</div>
                    <div class="invalid-feedback">Please fill out this field.</div>
                </div>
